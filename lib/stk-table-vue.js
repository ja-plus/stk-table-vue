...
async function getDropdownIns(onConfirm) {
  if (!DropdownIns) {
    const div = document.createElement("div");
    div.classList.add("stk-filter-dropdown-wrapper");
    document.body.appendChild(div);
    const DropdownApp = await import("./index-Bia-FgZA.js").then((module) => module.default);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["stk-filter", { "stk-filter--active": props.active }])
      }, [
...
function findStkTableInstance(instance) {
  var _a;
    ...
    return markRaw(
      defineComponent({
        ...
        setup(props) {
          ...
          function handleUpdateFilterStatus(value) {
            var _a;
            filterStatus.value[colKey] = { value };
            (_a = stkTableInstance == null ? void 0 : stkTableInstance.exposed) == null ? void 0 : _a.setFilter(filterStatus.value);
          }
          return () => h(
            _sfc_main,
            {
