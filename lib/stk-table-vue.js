...
function useAutoResize({ initVirtualScroll, props, debounceMs }) {
  onMounted(() => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function scrollTo2(top = 0, left = 0) {
      if (!tableContainer.value)
        return;
      if (top !== null)
