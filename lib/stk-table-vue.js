 ...
 * license: MIT
 */
import { a as registerFeature, c as insertToOrderedArray, i as TreeFoldIcon_default, l as strCompare, n as TreeNodeCell_default, o as useAreaSelection, r as TreeIndent_default, s as binarySearch, t as StkTable_default, u as tableSort } from "./StkTable-BeKPDuZs.js";
...
async function getDropdownIns() {
	if (!DropdownIns) {
		...
		DropdownIns = createApp(await import("./Dropdown-BA5i2ywu.js").then((module) => module.default)).mount(div);
	}
	return DropdownIns;
}
//#endregion
...
//#endregion
export { StkTable_default as StkTable, TreeNodeCell_default as StkTreeCell, TreeFoldIcon_default as StkTreeFoldIcon, TreeIndent_default as StkTreeIndent, binarySearch, createChangeCell, createCheckboxCell, createEditableCell, createFilterCell, createNumberCell, formatNumber, insertToOrderedArray, registerFeature, strCompare, tableSort, useAreaSelection };
