...
function useScrollbar({ containerRef, virtualScroll, virtualScrollX }, options = ref(false)) {
...
function useCellSelection({
  ...
  function checkAutoScroll() {
    ...
    const nearEdge = lastMouseClientY < rect.top + EDGE_ZONE || lastMouseClientY > rect.bottom - EDGE_ZONE || lastMouseClientX < rect.left + EDGE_ZONE || lastMouseClientX > rect.right - EDGE_ZONE;
  ...
  function getCellSelectionClasses(cellKey, absoluteRowIndex, colKey) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    cellSelection: { type: Boolean, default: false },
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { scrollbarOptions, scrollbar, showScrollbar, onVerticalScrollbarMouseDown, onHorizontalScrollbarMouseDown, updateCustomScrollbar } = useScrollbar({ containerRef: tableContainerRef, virtualScroll, virtualScrollX }, toRef(props, "scrollbar"));
    const {
      hiddenCellMap,
      //
      mergeCellsWrapper,
    ...
    const {
      ...
      getSelectedCells,
      clearSelectedCells
    } = useCellSelection({ props, emits, tableContainerRef, dataSourceCopy, tableHeaderLast, colKeyGen, cellKeyGen });
    watch(
      () => props.columns,
      () => {
        dealColumns();
