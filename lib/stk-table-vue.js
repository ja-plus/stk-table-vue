...
function useRowExpand(emits, dataSourceCopy, rowKeyGen) {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_2, [
          ...
          scrollbarOptions.value.enabled && unref(showScrollbar).y ? (openBlock(), createElementBlock("div", {
            ...
            style: normalizeStyle({
              ...
              transform: `translateY(${unref(scrollbar).t}px)`
            }),
        ...
        scrollbarOptions.value.enabled && unref(showScrollbar).x ? (openBlock(), createElementBlock("div", {
          ...
          style: normalizeStyle({
            ...
            transform: `translateX(${unref(scrollbar).l}px)`
          }),
...
async function getDropdownIns() {
  if (!DropdownIns) {
    ...
    const DropdownApp = await import("./index-t5SJ6KNv.js").then((module) => module.default);
