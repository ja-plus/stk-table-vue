          ...
          !_ctx.headless ? (openBlock(), createElementBlock("thead", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(tableHeaders.value, (row, rowIndex) => {
              return openBlock(), createElementBlock("tr", {
                key: rowIndex,
                onContextmenu: _cache[3] || (_cache[3] = ($event) => _ctx.$attrs.onHeaderRowMenu && ((e) => onHeaderMenu(e)))
              }, [
          ...
          createElementVNode("tbody", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtual_dataSourcePart), (row, rowIndex) => {
              ...
              return openBlock(), createElementBlock("tr", {
                ...
                onDblclick: ($event) => _ctx.$attrs.onRowDblclick && ((e) => onRowDblclick(e, row)),
                onContextmenu: ($event) => _ctx.$attrs.onRowMenu && ((e) => onRowMenu(e, row)),
                ...
                row && row.__EXPANDED_ROW__ ? (openBlock(), createElementBlock("td", {
                  ...
                  return openBlock(), createElementBlock("td", {
                    ...
                    onMousedown: ($event) => _ctx.$attrs.onCellMousedown && ((e) => onCellMouseDown(e, row, col)),
                    onMouseenter: ($event) => _ctx.$attrs.onCellMouseenter && ((e) => onCellMouseEnter(e, row, col)),
                    onMouseleave: ($event) => _ctx.$attrs.onCellMouseleave && ((e) => onCellMouseLeave(e, row, col)),
                    onMouseover: ($event) => _ctx.$attrs.onCellMouseover && ((e) => onCellMouseOver(e, row, col))
                  }, [
