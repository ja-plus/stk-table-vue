 ...
 * license: MIT
 */
import { a as insertToOrderedArray, i as binarySearch, n as registerFeature, o as strCompare, r as useAreaSelection, s as tableSort, t as StkTable_default } from "./StkTable-Dh6nR5Ac.js";
import { child, computed, createApp, createDynamicComponent, createIf, createSlot, defineComponent, defineVaporComponent, getCurrentInstance, h, markRaw, next, nextTick, on, ref, renderEffect, setClass, setDOMProp, setInsertionState, setProp, setStaticTemplateRef, setText, setValue, template, toDisplayString, txt, watch, withModifiers } from "vue";
...
async function getDropdownIns() {
	if (!DropdownIns) {
		...
		DropdownIns = createApp(await import("./Dropdown-F4Ui8JoL.js").then((module) => module.default)).mount(div);
	}
	return DropdownIns;
}
//#endregion
//#region src/StkTable/custom-cells/FilterCell/Filter.vue?vue&type=script&setup=true&vapor=true&lang.ts
var t0$2 = template("<span> ");
var t1$2 = template("<div><!><svg class=stk-filter-icon xmlns=http://www.w3.org/2000/svg viewBox=\"0 0 1024 1024\"><path fill=currentColor d=\"M950.58 0 l-894.06 0 q-91.93 17.17 -34.34 119.21 l293.97 251.54 l6.06 9.1 q16.17 20.2 16.17 47.48 l0 468.74 l1.01 8.08 q3.03 10.11 9.09 19.2 q2.02 2.02 5.05 7.07 q36.37 33.34 84.86 4.04 l216.19 -124.26 q21.21 -22.22 18.18 -50.51 l0 -332.36 l1.01 -11.12 q4.04 -26.26 22.23 -45.46 l292.96 -251.54 l9.1 -10.11 q43.44 -54.55 14.14 -81.82 q-28.29 -27.28 -61.62 -27.28 ZM832.38 119.21 l-277.81 235.38 l0 377.82 l-96.98 55.57 l0 -433.39 l-275.8 -235.38 l650.59 0 Z\">", 1);
//#endregion
//#region src/StkTable/custom-cells/FilterCell/Filter.vue
var Filter_default = /* @__PURE__ */ defineVaporComponent({
	__name: "Filter",
	props: {
		col: {},
		rowIndex: {},
	...
	setup(__props, { emit: __emit }) {
		...
		const n4 = child(n5);
		const n3 = next(n4);
		renderEffect(() => setClass(n5, ["stk-filter", [{ "stk-filter--active": props.active }, `stk-filter--${theme.value}`]]));
		setInsertionState(n5, n4);
		createSlot("default", null, () => {
			const n2 = t0$2();
			const x2 = txt(n2);
			renderEffect(() => setText(x2, toDisplayString(props.col.title)));
			return n2;
		});
		on(n3, "click", handleIconClick);
		return n5;
	}
});
//#endregion
...
//#endregion
//#region src/StkTable/custom-cells/EditableCell/EditableCell.vue?vue&type=script&setup=true&vapor=true&lang.ts
var t0$1 = template(" ");
var t1$1 = template("<input class=stk-editable-cell-input>");
var t2 = template("<div class=stk-editable-cell>", 1);
//#endregion
//#region src/StkTable/custom-cells/EditableCell/EditableCell.vue
var EditableCell_default = /* @__PURE__ */ defineVaporComponent({
	__name: "EditableCell",
	props: {
		row: {},
		col: {},
	...
	setup(__props) {
		...
		createIf(() => !editing.value, () => {
			const n2 = t0$1();
			renderEffect(() => setText(n2, toDisplayString(displayValue.value)));
			return n2;
		}, () => {
			const n4 = t1$1();
			on(n4, "blur", onBlur);
			...
			setStaticTemplateRef(n4, inputRef, null, "inputRef");
			renderEffect(() => setValue(n4, editValue.value));
			return n4;
		}, 261);
		on(n5, "dblclick", onTrigger);
		on(n5, "click", onTrigger);
		setStaticTemplateRef(n5, rootRef, null, "rootRef");
		return n5;
	}
});
//#endregion
...
//#endregion
//#region src/StkTable/custom-cells/CheckboxCell/CheckboxCell.vue?vue&type=script&setup=true&vapor=true&lang.ts
var t0 = template("<input type=checkbox class=stk-checkbox-native>");
var t1 = template("<div class=stk-checkbox-cell>", 1);
//#endregion
//#region src/StkTable/custom-cells/CheckboxCell/CheckboxCell.vue
var CheckboxCell_default = /* @__PURE__ */ defineVaporComponent({
	__name: "CheckboxCell",
	props: {
	...
	setup(__props, { emit: __emit }) {
		...
		const n5 = t1();
		setInsertionState(n5);
		createIf(() => __props.customComponent, () => {
			const _on_click = () => {};
			return createDynamicComponent(() => __props.customComponent, {
				...
				onChange: () => handleChange,
				onClick: () => withModifiers(_on_click, ["stop"])
			});
		}, () => {
			const n4 = t0();
			on(n4, "change", handleChange);
			on(n4, "click", withModifiers(() => {}, ["stop"]));
			renderEffect(() => {
				setProp(n4, "checked", __props.checked);
				setDOMProp(n4, "indeterminate", __props.indeterminate);
			});
			return n4;
		}, 261);
		return n5;
