...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const SRBRTotalHeight = computed(() => {
      ...
      return dataSourceCopy.value.length * virtualScroll.value.rowHeight + tableHeaderHeight.value + (virtualScroll.value.containerHeight - tableHeaderHeight.value) % virtualScroll.value.rowHeight;
    });
