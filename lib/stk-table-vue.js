                  ...
                  row && row.__EXP_R__ ? (openBlock(), createElementBlock("td", {
                    ...
                    return openBlock(), createElementBlock(Fragment, null, [
                      !unref(hiddenCellMap) || !((_a = unref(hiddenCellMap)[rowKeyGen(row)]) == null ? void 0 : _a.has(colKeyGen.value(col))) ? (openBlock(), createElementBlock("td", mergeProps({
                        ...
                        col.customCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customCell), {
                        ...
                        }, toDisplayString((row && row[col.dataIndex]) ?? getEmptyCellText.value(col, row)), 9, _hoisted_12)) : col.type === "seq" ? (openBlock(), createElementBlock("div", _hoisted_13, toDisplayString((props.seqConfig.startIndex || 0) + getRowIndex(rowIndex) + 1), 1)) : col.type === "tree-node" ? (openBlock(), createBlock(_sfc_main$1, {
                          key: 3,
                          class: "table-cell-wrapper",
                          col,
                          row,
                          ...
                          row[col.dataIndex] != null ? (openBlock(), createElementBlock("span", _hoisted_15, toDisplayString(row[col.dataIndex]), 1)) : createCommentVNode("", true)
                        ], 8, _hoisted_14))
                      ], 16)) : createCommentVNode("", true)
                    ], 64);
                  }), 256)),
                  unref(virtualX_on) ? (openBlock(), createElementBlock("td", _hoisted_16)) : createCommentVNode("", true)
                ], 16, _hoisted_8);
              }), 128)),
              unref(virtual_on) && !unref(isSRBRActive) ? (openBlock(), createElementBlock("tr", {
                key: 1,
