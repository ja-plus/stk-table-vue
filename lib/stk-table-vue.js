...
function separatedData(sortOption, targetDataSource, sortType) {
  const nanArr = [];
  const numArr = [];
...
function tableSort(sortOption, order, dataSource, option = {}) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    emptyValueSortToBottom: { type: Boolean, default: false }
  },
