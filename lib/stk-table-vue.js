...
function _sfc_render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("span", _hoisted_1$4, [..._cache[0] || (_cache[0] = [
...
const DragHandle = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$2]]);
const _sfc_main$4 = {};
const _hoisted_1$3 = {
...
const SortIcon = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1]]);
const _sfc_main$3 = {};
const _hoisted_1$2 = { class: "stk-fold-icon" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$2);
}
const TriangleIcon = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render]]);
...
function getClosestColKey(target) {
  var _a;
  return (_a = target == null ? void 0 : target.closest("td")) == null ? void 0 : _a.dataset.colKey;
}
...
function useAreaSelection(props, emits, tableContainerRef, dataSourceCopy, tableHeaderLast, colKeyGen, cellKeyGen, scrollTo, virtualScroll, virtualScrollX) {
  const EDGE_ZONE = 40;
  ...
  function updateSelectionFromPoint(container, containerRect) {
    ...
    if (!el) return;
    const td = (_a = el.closest) == null ? void 0 : _a.call(el, "td");
    const tr = (_b = el.closest) == null ? void 0 : _b.call(el, "tr");
    if (!td || !tr) return;
  ...
  function getSelectedArea() {
    const range = selectionRange.value;
    if (!range) return { rows: [], cols: [], range: null };
    const { minRow, maxRow, minCol, maxCol } = normalizeRange(range);
    const data = dataSourceCopy.value;
    const cols = tableHeaderLast.value;
    return {
...
function useRowDragSelection(props, emits, tableContainerRef, dataSourceCopy, rowKeyGen, scrollTo, virtualScroll) {
  const EDGE_ZONE = 40;
  const SCROLL_SPEED_MAX = 15;
  const POINT_EDGE_OFFSET = 2;
  ...
  function getSelectedRowsFromRanges(ranges) {
  ...
  function buildRangesFromIndices(rowIndexList) {
  ...
  function calculateAutoScrollDelta(mouseY, rect) {
  ...
  function removeRowIndexFromRanges(rowIndex) {
  ...
  function updateSelectionEnd(endRowIndex) {
  ...
  function autoScrollLoop() {
    ...
    if (deltaY !== 0) {
      const currentScrollTop = ((_a = props.experimental) == null ? void 0 : _a.scrollY) ? virtualScroll.value.scrollTop : container.scrollTop;
  ...
  function updateSelectionFromPoint(container, containerRect) {
    ...
    const el = document.elementFromPoint(x, y);
    if (!el) return;
    const tr = (_a = el.closest) == null ? void 0 : _a.call(el, "tr");
    if (!tr) return;
    const rowIndex = getClosestTrIndex(tr);
    if (Number.isNaN(rowIndex) || rowIndex < 0) return;
    updateSelectionEnd(rowIndex);
  ...
  function getRowSelectionClasses(absoluteRowIndex) {
  ...
  function setSelectedRows(rowKeyOrRows, option = {}) {
    if (!(rowKeyOrRows == null ? void 0 : rowKeyOrRows.length)) {
      clearSelectedRows();
      if (!option.silent) {
    ...
    const rowIndexList = rowKeyOrRows.map((item) => {
      if (typeof item === "string" || typeof item === "number") {
        return dataSourceCopy.value.findIndex((row) => rowKeyGen(row) === item);
      }
      return dataSourceCopy.value.indexOf(item);
...
const useRowDragSelectionName = "useRowDragSelection";
useRowDragSelection[MY_FN_NAME] = useRowDragSelectionName;
...
function useMergeCells(rowActiveProp, tableHeaderLast, rowKeyGen, colKeyGen, virtual_dataSourcePart) {
  ...
  return [hiddenCellMap, mergeCellsWrapper, hoverMergedCells, updateHoverMergedCells, activeMergedCells, updateActiveMergedCells];
}
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    rowDragSelection: { type: [Boolean, Object], default: false },
    ...
    function filterDataSource(dataSource) {
      ...
      return dataSource.filter((row) => {
        return filterKeys.every((key) => {
          ...
          if (!(value == null ? void 0 : value.length)) return true;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        class: normalizeClass(["stk-table", {
          ...
          "is-row-drag-selecting": unref(isRowDragSelecting),
        ...
        createElementVNode("div", _hoisted_2, [
          createElementVNode("table", {
            ...
            !__props.headless ? (openBlock(), createElementBlock("thead", _hoisted_3, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(tableHeaders), (row, rowIndex) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_on) && rowIndex === unref(tableHeaders).length - 1 ? unref(virtualX_columnPart) : row, (col, colIndex) => {
            ...
            createElementVNode("tbody", {
              ...
              !isExperimentalScrollY.value && unref(virtual_on) && !unref(isSRBRActive) ? (openBlock(), createElementBlock("tr", {
                ...
                unref(virtualX_on) && __props.fixedMode && __props.headless ? (openBlock(), createElementBlock("td", _hoisted_12)) : createCommentVNode("", true),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtual_dataSourcePart), (row, rowIndex) => {
                return openBlock(), createElementBlock("tr", mergeProps({
                  ...
                  ], 8, _hoisted_15)) : (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(unref(virtualX_columnPart), (col, colIndex) => {
                    return openBlock(), createElementBlock(Fragment, null, [
                      !shouldHideCell(row, col) ? (openBlock(), createElementBlock("td", mergeProps({
                        key: colKeyGen.value(col)
                        ...
                        col.customCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customCell), {
                        ...
                        }, toDisplayString((row && row[col.dataIndex]) ?? getEmptyCellText.value(col, row)), 9, _hoisted_17)) : col.type === "seq" ? (openBlock(), createElementBlock("div", _hoisted_18, toDisplayString((props.seqConfig.startIndex || 0) + getRowIndex(rowIndex) + 1), 1)) : col.type === "tree-node" ? (openBlock(), createBlock(_sfc_main$2, {
                          key: 3,
                          class: "table-cell-wrapper",
                          col,
                          row,
                          ...
                          col.type === "dragRow" ? (openBlock(), createBlock(DragHandle, {
                            key: 0,
                            onDragstart: ($event) => unref(onTrDragStart)($event, getRowIndex(rowIndex))
                          }, null, 8, ["onDragstart"])) : col.type === "expand" ? (openBlock(), createBlock(TriangleIcon, {
                            key: 1,
                            onClick: ($event) => triangleClick($event, row, col)
                          }, null, 8, ["onClick"])) : createCommentVNode("", true),
                          row[col.dataIndex] != null ? (openBlock(), createElementBlock("span", _hoisted_20, toDisplayString(row[col.dataIndex]), 1)) : createCommentVNode("", true)
                        ], 8, _hoisted_19))
...
async function getDropdownIns() {
  if (!DropdownIns) {
    ...
    const DropdownApp = await import("./index-C40Rz-HL.js").then((module) => module.default);
      ...
      defineComponent({
        ...
        setup(props) {
          ...
          function handleChange(value) {
            ...
            (_a = stkTableInstance == null ? void 0 : stkTableInstance.exposed) == null ? void 0 : _a.setFilter(filterStatus.value, option);
          }
          return () => h(
            _sfc_main,
            {
