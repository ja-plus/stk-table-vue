 ...
 * license: MIT
 */
import { createElementBlock, openBlock, createElementVNode, defineComponent, normalizeStyle, createBlock, createCommentVNode, toDisplayString, watch, onMounted, onBeforeUnmount, ref, computed, shallowRef, onUnmounted, nextTick, customRef, toRaw, normalizeClass, unref, renderSlot, Fragment, renderList, mergeProps, resolveDynamicComponent, createTextVNode, withCtx, createVNode } from "vue";
...
const DragHandle = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2]]);
const _sfc_main$3 = {};
const _hoisted_1$3 = {
...
const SortIcon = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1]]);
const _sfc_main$2 = {};
const _hoisted_1$2 = { class: "stk-fold-icon" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$2);
}
const TriangleIcon = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render]]);
...
function useScrollbar({ props, containerRef, virtualScroll, virtualScrollX }) {
  const defaultOptions = ref({ enabled: true, minHeight: 20, minWidth: 20, width: 8, height: 8 });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { tableHeaders, tableHeadersForCalc, dealColumns } = useTableColumns({
    ...
    const { scrollbarOptions, scrollbar, showScrollbar, onVerticalScrollbarMouseDown, onHorizontalScrollbarMouseDown, updateCustomScrollbar } = useScrollbar({ props, containerRef: tableContainerRef, virtualScroll, virtualScrollX });
    const {
      hiddenCellMap,
      //
      mergeCellsWrapper,
    ...
    const {
      ...
      getSelectedArea,
      clearSelectedArea
    } = useAreaSelection({ props, emits, tableContainerRef, dataSourceCopy, tableHeaderLast, colKeyGen, cellKeyGen });
    watch(
      () => props.columns,
      () => {
        handleDealColumns();
    ...
    function rowKeyGen(row) {
      ...
      const cachedRowKey = row.__ROW_K__;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        class: normalizeClass(["stk-table", {
          ...
          "is-cell-selecting": unref(isCellSelecting)
        }]),
                  ...
                  row && row.__EXP_R__ ? (openBlock(), createElementBlock("td", {
                    ...
                    return openBlock(), createElementBlock(Fragment, null, [
                      !unref(hiddenCellMap) || !((_a = unref(hiddenCellMap)[rowKeyGen(row)]) == null ? void 0 : _a.has(colKeyGen.value(col))) ? (openBlock(), createElementBlock("td", mergeProps({
                        ...
                        }, toDisplayString((row && row[col.dataIndex]) ?? getEmptyCellText.value(col, row)), 9, _hoisted_13)) : col.type === "seq" ? (openBlock(), createElementBlock("div", _hoisted_14, toDisplayString((props.seqConfig.startIndex || 0) + getRowIndex(rowIndex) + 1), 1)) : col.type === "tree-node" ? (openBlock(), createBlock(_sfc_main$1, {
                          key: 3,
                          class: "table-cell-wrapper",
                          col,
                          row,
