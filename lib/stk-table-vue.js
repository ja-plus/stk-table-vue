 ...
 * license: MIT
 */
import { a as insertToOrderedArray, i as binarySearch, n as registerFeature, o as strCompare, r as useAreaSelection, s as tableSort, t as StkTable_default } from "./StkTable-UiOXnC9Z.js";
...
async function getDropdownIns() {
	if (!DropdownIns) {
		...
		DropdownIns = createApp(await import("./Dropdown-D-DjrwRU.js").then((module) => module.default)).mount(div);
	}
	return DropdownIns;
}
//#endregion
