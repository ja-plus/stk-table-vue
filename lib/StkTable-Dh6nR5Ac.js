 ...
 * license: MIT
 */
import { child, computed, createComponent, createDynamicComponent, createElementBlock, createElementVNode, createFor, createIf, createSlot, createTemplateRefSetter, customRef, defineVaporComponent, extend, next, nextTick, on, onBeforeUnmount, onMounted, onUnmounted, openBlock, provide, ref, renderEffect, setAttr, setClass, setClassName, setDynamicProps, setInsertionState, setProp, setStaticTemplateRef, setStyle, setText, shallowRef, template, toDisplayString, toRaw, toRef, triggerRef, txt, unref, watch } from "vue";
...
function _sfc_render$2(_ctx, _cache) {
	return openBlock(), createElementBlock("span", _hoisted_1$2, [..._cache[0] || (_cache[0] = [createElementVNode("svg", {
...
function _sfc_render$1(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$1, [..._cache[0] || (_cache[0] = [createElementVNode("polygon", {
		class: "arrow-up",
		fill: "#757699",
...
var _sfc_main = {};
var _hoisted_1 = { class: "stk-fold-icon" };
