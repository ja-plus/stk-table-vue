...
function useVirtualScroll(props, tableContainerRef, trRef, dataSourceCopy, tableHeaderLast, tableHeaders, rowKeyGen, maxRowSpan, scrollbarOptions, isExperimentalScrollY) {
	...
	*/
	let colMergeLeftReach = null;
	let colMergeRightEnd = null;
	/**
	...
	*/
	...
	function updateVirtualXColMerge() {
		...
		colMergeLeftReach = (result === null || result === void 0 ? void 0 : result.leftReach) ?? null;
		colMergeRightEnd = (result === null || result === void 0 ? void 0 : result.rightEnd) ?? null;
	}
	/**
	* virtual-x 列合并覆盖信息。
	...
	*/
	const virtualX_colMergeRange = computed(() => {
		...
		return {
			leftReach: colMergeLeftReach,
			rightEnd: colMergeRightEnd
		};
	});
	/**
	* 经列合并修正后的可视列范围。
...
var StkTable_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		*/
		...
		const [virtualScroll, virtualScrollX, virtual_on, virtual_dataSourcePart, virtual_offsetBottom, virtualX_on, virtualX_offsetRight, tableHeaderHeight, initVirtualScroll, initVirtualScrollY, initVirtualScrollX, updateVirtualScrollY, updateVirtualScrollX, setAutoHeight, clearAllAutoHeight, clearColWidthCache, updateVirtualXColMerge, virtualX_tableHeaders, expandRowColspan, theadVirtualX, virtualX_columnPart] = useVirtualScroll(props, tableContainerRef, trRef, dataSourceCopy, tableHeaderLast, tableHeaders, rowKeyGen, maxRowSpan, scrollbarOptions, isExperimentalScrollY);
