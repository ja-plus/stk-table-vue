...
export default defineComponent({
    ...
    computed: {
        ...
        virtual_dataSourcePart() {
            ...
            return this.dataSourceCopy.slice(this.virtualScroll.startIndex, this.virtualScroll.startIndex + this.virtual_pageSize);
        },
        /** 虚拟表格定位下边距*/
        ...
        virtualX_on() {
            return (
                this.virtualX &&
                this.tableHeaderLast.reduce((sum, col) => (sum += parseInt(col.minWidth || col.width)), 0) > this.virtualScrollX.containerWidth * 1.5
            );
        },
