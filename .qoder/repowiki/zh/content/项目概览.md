...
- [docs-src/en/index.md](file://docs-src/en/index.md)
...
- **新增功能**：增强的国际化配置支持，涵盖中文、英文、日文、韩文等多语言版本，提供统一的文档体验
...
- docs-src：VitePress 文档站点源码，含多语言文档（中文、英文、日文、韩文）
...
- **国际化支持**：完整的多语言文档体系，支持中文、英文、日文、韩文等多种语言版本
...
### 国际化与多语言支持
- **多语言文档**：完整的国际化文档体系，支持中文、英文、日文、韩文四种语言版本
- **统一架构**：各语言版本的文档结构保持一致，便于维护和内容同步
- **样式改进**：所有语言版本均享有统一的样式设计和用户体验
- **内容增强**：首页内容经过优化，提供更好的引导和信息展示
...
- **多语言问题**：检查语言配置文件是否正确加载，确认文档路由配置

[本节为通用指导，不直接分析具体文件]

## 结论
stk-table-vue 以清晰的"主组件 + 功能 Hook"架构，提供了完善的大数据表格能力与灵活的扩展机制。通过虚拟滚动、树形数据、自定义单元格、排序、合并单元格、固定列、拖拽与键盘导航等特性，能够覆盖绝大多数企业级表格场景。**新增的国际化支持和增强的文档体验**使得该组件库能够更好地服务全球开发者社区。对于初学者，可从基础示例入手逐步掌握；对于有经验的开发者，可通过扩展机制与 Hook 深入定制，满足复杂业务需求。
...
- **多语言文档**：支持中文、英文、日文、韩文四种语言版本，提供统一的文档体验
