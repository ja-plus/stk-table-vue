import{_ as n,A as b}from"./chunks/index.CjdUzutU.js";import{d as m,p,o as c,c as u,j as r,G as d,F as h,_ as v,a2 as f,w as o,k as s,B as k}from"./chunks/framework.BnGeyzQu.js";const S=`<script lang="ts" setup>\r
...
`,x=m({__name:"Default",setup(i){const t=[{title:"Name",dataIndex:"name"},{title:"Age",dataIndex:"age"},{title:"Address",dataIndex:"address"},{title:"Gender",dataIndex:"gender"}],a=p(new Array(3).fill(0).map((l,e)=>({name:`Jack ${e}`,age:18+e,address:`Beijing Forbidden City ${e}`,gender:e%2===0?"male":"female"})));return(l,e)=>(c(),u(h,null,[r("article",null,[e[0]||(e[0]=r("header",null,"bordered",-1)),d(n,{bordered:"",columns:t,"data-source":a.value},null,8,["data-source"])]),r("article",null,[e[1]||(e[1]=r("header",null,"bordered=false - 没有分割线",-1)),d(n,{bordered:!1,columns:t,"data-source":a.value},null,8,["data-source"])]),r("article",null,[e[2]||(e[2]=r("header",null,'bordered="h"- 仅横线',-1)),d(n,{bordered:"h",columns:t,"data-source":a.value},null,8,["data-source"])]),r("article",null,[e[3]||(e[3]=r("header",null,'bordered="v" - 仅竖线',-1)),d(n,{bordered:"v",columns:t,"data-source":a.value},null,8,["data-source"])]),r("article",null,[e[4]||(e[4]=r("header",null,'bordered="body-v" - 表头横竖线，表体仅竖线',-1)),d(n,{bordered:"body-v",columns:t,"data-source":a.value},null,8,["data-source"])])],64))}}),g=v(x,[["__scopeId","data-v-094e64fd"]]),A=JSON.parse('{"title":"边框","description":"","frontmatter":{},"headers":[],"relativePath":"table/basic/bordered.md","filePath":"table/basic/bordered.md","lastUpdated":1734616288000}'),_={name:"table/basic/bordered.md"},C=Object.assign(_,{setup(i){return(t,a)=>{const l=k("ClientOnly");return c(),u("div",null,[a[0]||(a[0]=f('<h1 id="边框" tabindex="-1">边框 <a class="header-anchor" href="#边框" aria-label="Permalink to &quot;边框&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>配置 <code>bordered</code> 实现表格边框， 取值 <code>true</code> | <code>false</code> | <code>h</code> | <code>v</code> | <code>body-v</code>。</p><p>出于滚动条影响，表格右侧和底部的边框，由单元格的 <code>border-right</code> 和 <code>border-bottom</code> 实现。因此会消失。您可根据实际情况自行添加css。</p></div>',2)),d(l,null,{default:o(()=>[d(s(b),{title:"",description:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,vueCode:s(S)},{vue:o(()=>[d(g)]),_:1},8,["vueCode"])]),_:1})])}}});export{A as __pageData,C as default};
