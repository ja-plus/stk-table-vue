...
## 구현 설명
`customCell` 을 사용하여 input 을 직접 구현합니다.

::: tip change 이벤트
이벤트 버스 ([CustomEvent](https://developer.mozilla.org/ko/docs/Web/API/CustomEvent/CustomEvent) / [mitt](https://www.npmjs.com/package/mitt)) 또는 기타 방법을 통해 `EditCell` 의 change 이벤트를 외부에 알릴 수 있습니다.
:::
