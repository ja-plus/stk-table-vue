...
| 测试场景 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| 纵向 10K行 | 11.79 | 11.20 | 12.48 | 16.85 | 13.18 | 11.20 | 11.83 | 23.33 |
| 纵向 50K行 | 36.62 | 37.34 | 37.05 | 52.32 | 43.60 | 38.16 | 44.10 | 76.75 |
| 非虚拟 500行 | 333.48 | 253.71 | 225.71 | 243.37 | 185.95 | 182.46 | 183.82 | 417.78 |
| 横向 30列 | 29.45 | 28.93 | 25.41 | 27.36 | 25.22 | 28.95 | 26.80 | 36.53 |
| 横向 50列 | 18.20 | 19.77 | 16.75 | 19.12 | 17.38 | 19.89 | 18.72 | 22.54 |
| 合并 rowspan | 13.39 | 14.13 | 10.69 | 10.13 | 10.35 | 13.55 | 9.02 | 12.83 |
| 合并 colspan | 10.61 | 10.01 | 11.81 | 9.26 | 11.00 | 11.37 | 11.72 | 11.94 |
| 合并 mixed | 7.61 | 11.40 | 8.52 | 7.75 | 7.41 | 7.27 | 6.60 | 9.79 |
| 3层表头 | 7.30 | 7.96 | 16.90 | 9.95 | 6.86 | 7.26 | 6.34 | 10.49 |
| 合并+多级表头 | 10.01 | 17.27 | 13.23 | 8.27 | 8.57 | 6.39 | 6.05 | 9.42 |
| 合并+virtualX | 15.26 | 23.61 | 19.02 | 17.89 | 13.78 | 14.95 | 14.07 | 20.03 |
| 全功能 | 15.47 | 17.94 | 17.08 | 15.35 | 11.31 | 13.79 | 13.20 | 16.76 |
| 变高 10K行 | - | - | - | - | - | - | - | 37.45 |
| 变高 50K行 | - | - | - | - | - | - | - | 180.67 |
| 变高 setAutoHeight | - | - | - | - | - | - | - | - |
...
| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.01 | 0.02 | 0.01 | 0.02 | 0.02 | 0.02 | 0.05 | 1.75 |
| scrollDeep | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.02 | 0.02 | 1.48 |

### 纵向 50K行

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollDeep | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.02 | 0.01 | 1.46 |

### 横向 30列

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollX | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.71 |
| scrollXY | 0.02 | 0.02 | 0.02 | 0.01 | 0.01 | 0.02 | 0.02 | 0.74 |

### 横向 50列

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollX | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.74 |

### 合并 rowspan

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.13 | 0.16 | 0.13 | 0.13 | 0.12 | 0.12 | 0.01 | 1.28 |

### 合并 colspan

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 1.01 |

### 合并 mixed

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.08 | 0.10 | 0.09 | 0.08 | 0.08 | 0.08 | 0.01 | 0.90 |

### 3层表头

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 1.02 |

### 合并+多级表头

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.10 | 0.11 | 0.10 | 0.09 | 0.08 | 0.08 | 0.01 | 0.93 |

### 合并+virtualX

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollXY | 0.05 | 0.07 | 0.13 | 0.11 | 0.09 | 0.10 | 0.01 | 0.82 |

### 全功能

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollXY | 0.04 | 0.05 | 0.05 | 0.05 | 0.04 | 0.04 | 0.02 | 0.69 |
...
| 测试场景 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| 纵向 10K行 | 66 | 67 | 67 | 67 | 67 | 67 | 67 | 67 |
| 纵向 50K行 | 66 | 67 | 67 | 67 | 67 | 67 | 67 | 67 |
| 非虚拟 500行 | 5520 | 5521 | 5521 | 5521 | 5521 | 5521 | 5521 | 5521 |
| 横向 30列 | 43 | 44 | 44 | 55 | 44 | 44 | 44 | 44 |
| 横向 50列 | 43 | 44 | 44 | 55 | 44 | 44 | 44 | 44 |
| 合并 rowspan | 67 | 68 | 68 | 68 | 68 | 68 | 59 | 59 |
| 合并 colspan | 62 | 63 | 63 | 63 | 63 | 63 | 63 | 63 |
| 3层表头 | 79 | 80 | 80 | 80 | 80 | 80 | 80 | 80 |
| 变高 10K行 | - | - | - | - | - | - | - | 67 |
| 变高 50K行 | - | - | - | - | - | - | - | 67 |

## 总览 — 构建产物体积

> 统计 `pnpm build` 输出的 `lib/` 根级产物文件（未压缩 ES 构建，vue 为 external）
...
```
[PERF] vertical_10k | mount=23.33 | domNodes=67 | renderedRows=4 | scrollMid=1.75 | scrollDeep=1.48
[PERF] vertical_50k | mount=76.75 | domNodes=67 | scrollDeep=1.46
[PERF] non_virtual_500 | mount=417.78 | domNodes=5521 | renderedRows=500
[PERF] virtualX_30cols | mount=36.53 | domNodes=44 | scrollX=0.71 | scrollXY=0.74
[PERF] virtualX_50cols | mount=22.54 | domNodes=44 | scrollX=0.74
[PERF] mergeCells_rowspan | mount=12.83 | domNodes=59 | scrollMid=1.28
[PERF] mergeCells_colspan | mount=11.94 | domNodes=63 | scrollMid=1.01
[PERF] mergeCells_mixed | mount=9.79 | scrollMid=0.9
[PERF] multi_header_3lvl | mount=10.49 | domNodes=80 | scrollMid=1.02
[PERF] merge+multiHeader | mount=9.42 | scrollMid=0.93
[PERF] merge+virtualX | mount=20.03 | scrollXY=0.82
[PERF] all_features | mount=16.76 | scrollXY=0.69
[PERF] autoRowHeight_10k | mount=37.45 | domNodes=67 | renderedRows=4 | scrollMid=0.9 | scrollDeep=0.88
[PERF] autoRowHeight_50k | mount=180.67 | domNodes=67 | scrollDeep=0.88
[PERF] autoRowHeight_setHeight | set100=0.87
```
