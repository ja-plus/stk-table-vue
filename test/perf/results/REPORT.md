...
|------------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| 纵向 10K行 | 11.79 | 11.20 | 12.48 | 16.85 | 13.18 | 11.20 | 11.83 | 20.73 |
| 纵向 50K行 | 36.62 | 37.34 | 37.05 | 52.32 | 43.60 | 38.16 | 44.10 | 86.95 |
| 非虚拟 500行 | 333.48 | 253.71 | 225.71 | 243.37 | 185.95 | 182.46 | 183.82 | 526.57 |
| 横向 30列 | 29.45 | 28.93 | 25.41 | 27.36 | 25.22 | 28.95 | 26.80 | 48.37 |
| 横向 50列 | 18.20 | 19.77 | 16.75 | 19.12 | 17.38 | 19.89 | 18.72 | 29.83 |
| 合并 rowspan | 13.39 | 14.13 | 10.69 | 10.13 | 10.35 | 13.55 | 9.02 | 17.52 |
| 合并 colspan | 10.61 | 10.01 | 11.81 | 9.26 | 11.00 | 11.37 | 11.72 | 15.64 |
| 合并 mixed | 7.61 | 11.40 | 8.52 | 7.75 | 7.41 | 7.27 | 6.60 | 13.31 |
| 3层表头 | 7.30 | 7.96 | 16.90 | 9.95 | 6.86 | 7.26 | 6.34 | 13.37 |
| 合并+多级表头 | 10.01 | 17.27 | 13.23 | 8.27 | 8.57 | 6.39 | 6.05 | 11.07 |
| 合并+virtualX | 15.26 | 23.61 | 19.02 | 17.89 | 13.78 | 14.95 | 14.07 | 22.76 |
| 全功能 | 15.47 | 17.94 | 17.08 | 15.35 | 11.31 | 13.79 | 13.20 | 25.26 |
| 变高 10K行 | - | - | - | - | - | - | - | 52.60 |
| 变高 50K行 | - | - | - | - | - | - | - | 317.35 |
| 变高 setAutoHeight | - | - | - | - | - | - | - | - |
...
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.01 | 0.02 | 0.01 | 0.02 | 0.02 | 0.02 | 0.05 | 1.76 |
| scrollDeep | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.02 | 0.02 | 1.30 |

### 纵向 50K行

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollDeep | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.02 | 0.01 | 1.54 |

### 横向 30列

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollX | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.78 |
| scrollXY | 0.02 | 0.02 | 0.02 | 0.01 | 0.01 | 0.02 | 0.02 | 1.33 |

### 横向 50列

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollX | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 1.33 |

### 合并 rowspan

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.13 | 0.16 | 0.13 | 0.13 | 0.12 | 0.12 | 0.01 | 2.33 |

### 合并 colspan

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 1.91 |

### 合并 mixed

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.08 | 0.10 | 0.09 | 0.08 | 0.08 | 0.08 | 0.01 | 1.68 |

### 3层表头

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 0.01 | 1.25 |

### 合并+多级表头

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollMid | 0.10 | 0.11 | 0.10 | 0.09 | 0.08 | 0.08 | 0.01 | 0.94 |

### 合并+virtualX

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollXY | 0.05 | 0.07 | 0.13 | 0.11 | 0.09 | 0.10 | 0.01 | 0.86 |

### 全功能

| 指标 | 0.8.14 | 0.9.3 | 0.10.0 | 0.11.15 | 1.0.4 | 1.1.0 | optimize-cell-merge-render | master |
|------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|--------------|
| scrollXY | 0.04 | 0.05 | 0.05 | 0.05 | 0.04 | 0.04 | 0.02 | 0.86 |
...
```
[PERF] vertical_10k | mount=20.73 | domNodes=67 | renderedRows=4 | scrollMid=1.76 | scrollDeep=1.3
[PERF] vertical_50k | mount=86.95 | domNodes=67 | scrollDeep=1.54
[PERF] non_virtual_500 | mount=526.57 | domNodes=5521 | renderedRows=500
[PERF] virtualX_30cols | mount=48.37 | domNodes=44 | scrollX=0.78 | scrollXY=1.33
[PERF] virtualX_50cols | mount=29.83 | domNodes=44 | scrollX=1.33
[PERF] mergeCells_rowspan | mount=17.52 | domNodes=59 | scrollMid=2.33
[PERF] mergeCells_colspan | mount=15.64 | domNodes=63 | scrollMid=1.91
[PERF] mergeCells_mixed | mount=13.31 | scrollMid=1.68
[PERF] multi_header_3lvl | mount=13.37 | domNodes=80 | scrollMid=1.25
[PERF] merge+multiHeader | mount=11.07 | scrollMid=0.94
[PERF] merge+virtualX | mount=22.76 | scrollXY=0.86
[PERF] all_features | mount=25.26 | scrollXY=0.86
[PERF] autoRowHeight_10k | mount=52.6 | domNodes=67 | renderedRows=4 | scrollMid=1.08 | scrollDeep=1.17
[PERF] autoRowHeight_50k | mount=317.35 | domNodes=67 | scrollDeep=1.49
[PERF] autoRowHeight_setHeight | set100=1.15
```
